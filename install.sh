...
sudo cp vhost/aulalibre.org.mx /etc/apache2/sites-available/aulalibre.org.mx
sudo cp vhost/aulalibre.org.mx /etc/apache2/sites-available/aulalibre.org.mx.conf
sudo cp vhost/www.aulalibre.org.mx /etc/apache2/sites-available/www.aulalibre.org.mx
sudo cp vhost/www.aulalibre.org.mx /etc/apache2/sites-available/www.aulalibre.org.mx.conf

sudo a2ensite aulalibre.org.mx
sudo a2ensite www.aulalibre.org.mx
sudo service apache2 restart
...
echo -e "\e[1m--- Install Symfony on aulalibre.org.mx ---\e[0m"
cd aulalibre.org.mx
